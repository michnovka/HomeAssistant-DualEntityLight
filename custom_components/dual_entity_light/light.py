...
from homeassistant.components.light import (
    ...
    ATTR_BRIGHTNESS, ATTR_RGB_COLOR, ATTR_XY_COLOR, ATTR_HS_COLOR, ATTR_RGBW_COLOR, ATTR_RGBWW_COLOR, ATTR_COLOR_TEMP_KELVIN, ATTR_EFFECT_LIST, ATTR_EFFECT, ATTR_COLOR_MODE
)
